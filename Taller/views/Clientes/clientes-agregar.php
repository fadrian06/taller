...
<body>
  ...
  <div class="container py-5">
    ...
    <div class="table-responsive">
      <table id="clientesTable" class="table table-striped dt-responsive nowrap" style="width:100%">
          ...
          try {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
              echo "<tr>
                                    ...
                                    <td>{$row['Dirección']}</td>
                                    <td>
                                        <button class='btn btn-warning btn-sm' onclick='editClient(\"{$row['Cédula']}\")'>Modificar</button>
                                        <button class='btn btn-danger btn-sm' onclick='deleteClient(\"{$row['Cédula']}\")'>Eliminar</button>
                                    </td>
                                </tr>";
            }
          } catch (PDOException $e) {
            echo "<tr><td colspan='10'>Error al obtener los datos: {$e->getMessage()}</td></tr>";
          }
          ?>
        </tbody>
      </table>

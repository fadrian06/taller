...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#vehiculos-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-car"></i><span>Vehículos</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="vehiculos-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="vehiculos-lista.html">
                        <i class="bi bi-circle"></i><span>Lista de Vehículos</span>
                    </a>
                </li>
                <li>
                        <a href="../Vehiculos/vehiculos-agregar.php">
                        <i class="bi bi-circle"></i><span>Agregar Vehículo</span>
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#servicios-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-tools"></i><span>Servicios</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#inventario-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-box-seam"></i><span>Inventario de Repuestos</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="inventario-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="inventario-creacion.html">
                        <i class="bi bi-circle"></i><span>Creación de Productos</span>
                    </a>
                </li>
                <li>
                    <a href="inventario-ingresos.html">
                        <i class="bi bi-circle"></i><span>Ingresos de Productos</span>
                    </a>
                </li>
                <li>
                    <a href="inventario-venta.html">
                        <i class="bi bi-circle"></i><span>Venta de Repuestos</span>
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#reportes-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-file-earmark-text"></i><span>Reportes</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="reportes-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="reportes-clientes.html">
                        <i class="bi bi-circle"></i><span>Listados de Clientes</span>
                    </a>
                </li>
                <li>
                    <a href="reportes-vehiculos.html">
                        <i class="bi bi-circle"></i><span>Listados de Vehículos</span>
                    </a>
                </li>
                <li>
                    <a href="reportes-servicios.html">
                        <i class="bi bi-circle"></i><span>Servicios Individuales</span>
                    </a>
                </li>
                <li>
                    <a href="reportes-semanales-empleados.html">
                        <i class="bi bi-circle"></i><span>Reportes Semanales por Empleados</span>
                    </a>
                </li>
            </ul>
